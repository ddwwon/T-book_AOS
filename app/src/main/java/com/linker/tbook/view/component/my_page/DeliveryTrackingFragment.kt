...
import com.linker.tbook.view.component.my_page.myPageRecycler.cartData
import com.linker.tbook.view.component.my_page.myPageRecycler.deliverAdapter
import com.linker.tbook.view.component.my_page.myPageRecycler.deliverData
...
class DeliveryTrackingFragment : BaseFragment<FragmentDeliveryTrackingBinding> (
    ...
    // 배송 조회 RecyclerView
    private lateinit var deliverDatas: MutableList<deliverData>
    ...
    private fun initRecycler() {
        ...
        deliverDatas = mutableListOf<deliverData>()
        deliverAdapter.datas = deliverDatas
        binding.recyclerDeliveryItem.layoutManager = LinearLayoutManager(requireContext(), LinearLayoutManager.VERTICAL, false)
        binding.recyclerDeliveryItem.adapter = deliverAdapter
        binding.recyclerDeliveryItem.isNestedScrollingEnabled = true
    }

    private fun addDelivery(data: deliverData) {
        deliverDatas.add(data)
